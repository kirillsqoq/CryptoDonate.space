...
function Environment(props) {
  return props.children ? /*#__PURE__*/React.createElement(EnvironmentPortal, props) : /*#__PURE__*/React.createElement(EnvironmentMap, props);
}
...
function EnvironmentMap({
  ...
  React.useLayoutEffect(() => {
    ...
    return () => {
      target.environment = oldenv;
      target.background = oldbg; // Environment textures are volatile, better dispose and uncache them
...
export { Environment, EnvironmentMap, EnvironmentPortal };
