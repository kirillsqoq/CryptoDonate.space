...
var require_Edit2 = __commonJS({
  "node_modules/@spectrum-icons/workflow/Edit.js"(exports) {
    ...
    var _Edit = require_Edit();
    var _icon = (init_module(), __toCommonJS(module_exports));
    var _react = _interopRequireDefault(require_react());
    function Edit(props) {
      return _react.default.createElement(_icon.Icon, props, _react.default.createElement(_Edit.A4uEdit, null));
    }
  }
});

// dep:@spectrum-icons_workflow_Edit
var spectrum_icons_workflow_Edit_default = require_Edit2();
export {
  spectrum_icons_workflow_Edit_default as default
};
//# sourceMappingURL=@spectrum-icons_workflow_Edit.js.map
